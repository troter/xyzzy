...
#undef IDCANCEL
  ...
  /* usertool.cc */
  DEFUN3 (create-tool-bar, 4, 0, 0),
  DEFUN3 (show-tool-bar, 2, 4, 0),
  DEFUN3 (hide-tool-bar, 2, 0, 0),
  DEFUN3 (delete-tool-bar, 2, 0, 0),
  DEFUN3 (tool-bar-exist-p, 2, 0, 0),
  DEFUN3 (tool-bar-info, 2, 0, 0),
  DEFUN3 (list-tool-bars, 1, 0, 0),
  DEFCMD3 (focus-tool-bar, 1, 0, 0, ""),
  DEFUN3 (refresh-tool-bars, 1, 0, 0),
  DEFVAR2 (*tab-bar-horizontal-text*),

  /* usertab.cc */
  DEFUN3 (create-tab-bar, 3, 0, 0),
  DEFUN3 (tab-bar-add-item, 4, 2, FFneed_rest),
  DEFUN3 (tab-bar-delete-item, 3, 0, 0),
  DEFUN3 (tab-bar-select-item, 3, 0, 0),
  DEFUN3 (tab-bar-current-item, 2, 0, 0),
  DEFUN3 (tab-bar-find-item, 3, 0, 0),
  DEFUN3 (tab-bar-list-items, 2, 0, 0),
  DEFUN3 (tab-bar-modify-item, 3, 3, 0),
